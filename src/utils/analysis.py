...
class Analyzer(object):
    ...
    def analyze_classification(self, y_pred, y_true, class_names, excluded_classes=None, writer=None):
        """
        ...
        if self.plot:
            ...
            if writer is not None:
                writer.add_figure(tag="Confusion matrix", figure=figure,global_step=None)
        ...
        if self.plot:
            ...
            plt.show(block=False)
            if writer is not None:
                writer.add_figure(tag="Confusion matrix normalized", figure=figure, global_step=None)
