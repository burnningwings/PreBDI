...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--data_class', type=str, default='Bridge',
        ...
        self.parser.add_argument('--val_pattern', type=str, default='val',
        ...
        self.parser.add_argument('--lr_factor', type=str, default='0.5',
        ...
        self.parser.add_argument('--tod', type=int, default=5,
                                 help='Metric Tolerant distance')
        self.parser.add_argument('--tbw', action='store_true',
                                 help='write confuse matrix to tensorboard')
        self.parser.add_argument('--loss', choices={"NLLLOSS", "default"}, default="default",
                                 help='loss function')
        # Model
        import math
        self.parser.add_argument('--model', choices={"crossformer", "celk", "PreBDI", "ACLBDI", "CrossACL", "DANNBDI", "PreDBDI", "LSTM", "1DCNN", "HCG"}, default="crossformer",
                                 help="Model class")
        ...
        self.parser.add_argument("--if_domain", action='store_true', help='if use domain out')

        self.parser.add_argument('--num_nodes', type=int, default=30,
                                 help='Number of sensor')
        self.parser.add_argument('--input_len', type=int, default=128,
                                 help='the length of time window')
        self.parser.add_argument('--embed_dim', type=int, default=128,
                                 help='the STID feature dimension')
        self.parser.add_argument('--output_len', type=int, default=50,
                                 help='the output length')
        self.parser.add_argument('--num_CNNLayer', type=int, default=1,
                                 help='the num of CNNLayer')

        # CrossFormer arguments
        self.parser.add_argument('--cross_in_len', type=int, default=128, help='input MTS length (T)')
        self.parser.add_argument('--cross_out_len', type=int, default=128, help='output MTS length (au)')
        self.parser.add_argument('--cross_seg_len', type=int, default=16, help='segment length (L_seg)')
        self.parser.add_argument('--cross_win_size', type=int, default=2, help='window size for segment merge')
        self.parser.add_argument('--cross_factor', type=int, default=10, help='num of routers in Cross-Dimension Stage of TSA (c)')

        self.parser.add_argument('--cross_data_dim', type=int, default=30, help='Number of dimensions of the MTS data (D)')
        self.parser.add_argument('--cross_d_model', type=int, default=256, help='dimension of hidden states (d_model)')
        self.parser.add_argument('--cross_d_ff', type=int, default=512, help='dimension of MLP in transformer')
        self.parser.add_argument('--cross_n_heads', type=int, default=4, help='num of heads')
        self.parser.add_argument('--cross_e_layers', type=int, default=3, help='num of encoder layers (N)')
        self.parser.add_argument('--cross_dropout', type=float, default=0.2, help='dropout')
        self.parser.add_argument('--cross_baseline', action='store_true',
    ...
    def parse(self):
        ...
        args.Uni_node_list = [int(x) for x in args.Uni_node_list.split(',')]
